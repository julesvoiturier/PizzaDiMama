...
const DIYSelector = (props) => {
    ...
    return (
        <div className='w-[25%] max-md:w-full rounded-lg h-full bg-[#2d100b1c] p-2 flex flex-col gap-2 font-Switzer'>
            <div className='py-2 px-4 text-white font-bold bg-black rounded-md'>
