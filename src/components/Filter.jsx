...
const Filter = () => {
    ...
    return (
        <div className='w-full mt-[20px] ml-[20px] mb-[50px] flex gap-5  max-md:flex-col max-md:w-[100%] max-md:mb-[30px] font-Switzer'> 
            <button onClick={()=> dispatch(filterToggle())} className={`text-white font-bold px-8 rounded-md max-md:w-[130px] h-[40px] bg-main_orange ${openFilter == false ? 'active:scale-x-110':'active:scale-x-90'}`}>
                Filters
            </button>
            <div className={`${openFilter == true ? 'w-[80%] max-md:w-[100%] max-md:h-[100px] max-sm:h-[180px]' : 'w-[0%] max-sm:w-[100%] max-md:h-[0px]'} transition-all h-[40px] flex gap-5 max-md:gap-2 max-md:bg-[#eeebeb] max-md:rounded-md overflow-hidden max-md:flex-col max-md:top-4 max-sm:flex-row`}>
                <div className='flex h-full bg-[#00000042] rounded-md overflow-hidden max-sm:flex-col max-sm:w-[50%]'>
                    <div className='w-[100px] h-full bg-black text-white flex justify-center items-center max-md:w-[25%] max-sm:w-[100%]'>Price</div>
                ...
                <div className='flex h-full bg-[#00000042] rounded-md overflow-hidden max-sm:flex-col max-sm:w-[50%]'>
                    <div className='w-[100px] h-full bg-black text-white flex justify-center items-center max-md:w-[25%] max-sm:w-[100%]'>Base</div>
